...
export default function Intro() {
  return (
    <section>
      <div className="customLinear text-white relative w-full h-80 md:h-[520px] md:mt-10 mb-20 md:mb-32 overflow-hidden flex items-center ">
        <Image src={img} alt="img" className="object-cover lg:mt-44" />
